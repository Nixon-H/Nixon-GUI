...
export class RootTerminal extends Component {
    constructor() {
        ...
        this.child_directories = {
            ...
            projects: ["nixon-personal-portfolio", "synonyms-list-react", "webserver in c language", "Learn Management System", "flutter-banking-app", "Meditech-Healthcare"],
        ...
        switch (main) {
            ...
            case "code":
                if (words[0] === "." || words.length === 0) {
                    ...
                    result = "Command '" + main + "' not found, or not yet implemented.<br>Available Commands:[ cd, ls, pwd, echo, clear, exit, mkdir, code, nixoncli, chrome, firefox, about-nixon, trash, settings, sendmsg]";
                }
                break;
            case "echo":
