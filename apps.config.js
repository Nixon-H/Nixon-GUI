...
import displayNixonCli from './components/apps/nixoncli';
...
import { displayAboutNixon } from './components/apps/nixon';
...
const apps = [
    ...
    },
    {
        id: "Nixon-CLI",
        title: "Nixon-CLI",
        icon: './themes/Flat-Remix-Blue-Dark/apps/Nixon-CLI.png',
        disabled: false,
        favourite: true,
        desktop_shortcut: false,
        screen: displayNixonCli,
    },
    {
        id: "settings",
        title: "Settings",
